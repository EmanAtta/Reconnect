  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
        const Center(child: Text("Forgot password ?",style: TextStyle(color: AppColors.secondaryColor,fontSize: 20,fontWeight: FontWeight.bold),)),
        const Center(child: Text("enter email  address",style: TextStyle(color: AppColors.textolor,fontSize: 18),),),
        const Center(child: Text("associate with your account",style:TextStyle(color: AppColors.textolor,fontSize: 18)),),
        Padding(
        ...
        Padding(
          ...
          child: GestureDetector(onTap: (){Navigator.pushNamed(context, "verfiyCode");},child: button(button_text:"send code")),
        )
